...
<head>
    <meta charset="UTF-8">
    <title>Votre espace MonAsso : en attente de paiement</title>
</head>
<body style="font-family: Montserrat, Arial, sans-serif; background: #F6F3FF; color: #222;">
    <div style="max-width: 600px; margin: 0 auto; background: #fff; border-radius: 16px; padding: 32px; border-top: 6px solid #A259FF;">
        ...
        <p><strong>Pour activer votre espace, il vous suffit de finaliser le paiement sécurisé sur la page Stripe qui vient de s’ouvrir.</strong></p>
